...
{
      19,     0,    -1,    20,    -1,    20,    19,    -1,    -1,     3,
      13,    21,    -1,    21,    -1,     3,    -1,    21,    15,    21,
      -1,    21,    14,    21,    -1,    21,    16,    21,    -1,    21,
      17,    21,    -1,    14,    21,    -1,     4,    -1
};
...
{
  "$end", "error", "$undefined", "ID_NAME", "VALUETOKEN", "INT_TYPE",
  "FLOAT_TYPE", "BOOL_TYPE", "STRING_TYPE", "CHAR_TYPE", "VAR", "VAL",
...
#line 61 "project2.y"
    {
                ...
                VALUE rvalue = symbolTable.LookUp(*(yyvsp[(1) - (3)].idName)).value;
                if(rvalue.valueType == (yyvsp[(3) - (3)].value)->valueType){
...
#line 74 "project2.y"
    {
            // find the id in the symbol table
                VALUE idVal = symbolTable.LookUp(*(yyvsp[(1) - (1)].idName)).value;
  ...
  case 8:
#line 79 "project2.y"
    {(yyval.value) = new VALUE(oper('+', *(yyvsp[(1) - (3)].value), *(yyvsp[(3) - (3)].value)));}
    break;
...
#line 83 "project2.y"
    {
                VALUE value;
                value.valueType = (yyvsp[(2) - (2)].value)->valueType;
                ...
                (yyval.value) = new VALUE(oper('*', *(yyvsp[(2) - (2)].value), value));
            }
    break;
